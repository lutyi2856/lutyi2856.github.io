...
require("./video");
var phoneParent = document.querySelector('.contacts__field-phone');
var contactsForm = document.querySelector('.contacts__form');
var itemInput = document.querySelector('.contacts__input-name');
// ---------------------------------
...
var videoWrapper = document.querySelector('.information__wrapper-video');
var videoLink = videoWrapper.querySelector('.information__video-link');
var playButton = videoWrapper.querySelector('.information__play-button');
var preview = videoWrapper.querySelector('.information__wrapper-image-preview');
if (videoWrapper) {
